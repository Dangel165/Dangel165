...
<div style="background-color: #161b22; padding: 15px; border-radius: 10px; margin-top: 20px; border: 1px solid #30363d;">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=00FF41&center=true&vCenter=true&width=850&lines=Decoding+Encrypted+Message...;UHJvZ3JhbW1pbmcgbGFuZ3VhZ2VzIGFyZSB0b29scyB0aGF0IGNhbiBjcmVhdGUgYW55dGhpbmcsIGJ1dCBjb252ZXJzZWx5LCB0aGV5IGNhbiBhbHNvIGRlc3Ryb3kgYW55dGhpbmcu" alt="Encrypted Message" />
    <p style="color: #4CAF50; font-family: 'Fira Code', monospace; font-size: 0.8em; margin-top: 10px;">[ Hint: Base64 ]</p>
  </div>
  ...
  <table style="width: 100%; max-width: 850px; border-collapse: collapse; text-align: left; background-color: #0d1117; color: #c9d1d9; border: 1px solid #30363d;">
    ...
    <tbody>
      <tr style="border-bottom: 1px solid #30363d;">
        ...
        <td style="padding: 12px;"><b>2025 직업계고 창업아이템 공모전 (전국)</b><br/><span style="color: #8b949e; font-size: 0.8em;"></span></td>
      ...
      <tr style="border-bottom: 1px solid #30363d;">
        ...
        <td style="padding: 12px; text-align: center; font-size: 1.2em;">
          <a href="https://www.eroun.net/news/articleView.html?idxno=65595" style="text-decoration: none;">📰</a>
        </td>
      </tr>
      <tr style="border-bottom: 1px solid #30363d;">
  ...
  <table style="width: 100%; max-width: 850px; border-collapse: collapse; text-align: left; background-color: #0d1117; color: #c9d1d9; border: 1px solid #30363d;">
    ...
    <tbody>
      ...
      <tr style="border-bottom: 1px solid #30363d;">
        ...
        <td style="padding: 12px; text-align: center; font-size: 1.5em;">-</td>
        <td style="padding: 12px; text-align: center; font-size: 1.5em;">
          <a href="https://blog.naver.com/dangel798/224138618178" style="text-decoration: none;" title="Blog">📝</a>
        </td>
      </tr>
      <tr style="border-bottom: 1px solid #30363d;">
  ...
  <table style="width: 100%; max-width: 850px; border-collapse: collapse; text-align: left; background-color: #0d1117; color: #c9d1d9; border: 1px solid #30363d;">
    ...
    <tbody>
      <tr style="border-bottom: 1px solid #30363d;">
        ...
        <td style="padding: 12px; text-align: center; font-size: 1.5em;">
          <a href="https://blog.naver.com/dangel798/224145653930" style="text-decoration: none;" title="Analysis Report">📝</a>
        </td>
      </tr>
      <tr style="border-bottom: 1px solid #30363d;">
  ...
  <table style="width: 100%; max-width: 850px; border-collapse: collapse; text-align: left; background-color: #0d1117; color: #c9d1d9; border: 1px solid #30363d;">
    <tbody>
      ...
      <tr style="border-bottom: 1px solid #30363d;">
        <td style="padding: 15px;">
          <b style="color: #58a6ff; font-size: 1.1em;">💻 전주교육대학교 영재교육원 수료</b> (2018.03 ~ 2018.10)<br/>
